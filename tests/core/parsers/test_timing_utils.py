...
@pytest.mark.parametrize("timedelta_obj,expected", [
...
@pytest.mark.parametrize("input_tracks,expected_tracks", [
    # Basic case - no changes needed
    ([
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:00:00", end_time="00:01:00"),
        DomainTrack(name="Track 2", artist="Artist 2", start_time="00:01:00", end_time="00:02:00"),
    ], [
    ...
    ([
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:00:00", end_time="00:01:00"),
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:01:00", end_time="00:02:00"),
    ], [
...
def test_apply_timing_rules(input_tracks, expected_tracks):
    ...
    for i, (expected_start, expected_end, expected_name, expected_artist) in enumerate(expected_tracks):
...
def test_deduplicate_tracks(input_tracks, expected_tracks):
    timing_utils = TimingUtils()
    result = timing_utils._deduplicate_tracks(input_tracks)
...
@pytest.mark.parametrize("input_tracks,expected_tracks", [
    ...
    ([
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:00:30", end_time="00:01:00"),
    ], [
...
def test_add_intro_track(input_tracks, expected_tracks):
    timing_utils = TimingUtils()
    result = timing_utils._add_intro_track(input_tracks)
...
@pytest.mark.parametrize("input_tracks,expected_tracks", [
    ...
    ([
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:00:00", end_time="00:01:00"),
        DomainTrack(name="Track 2", artist="Artist 2", start_time="00:02:30", end_time="00:03:30"),
    ], [
        ("00:00:00", "00:01:00", "Track 1", "Artist 1"),
    ...
    ([
        DomainTrack(name="Track 1", artist="Artist 1", start_time="00:00:00", end_time="00:01:00"),
        DomainTrack(name="Track 2", artist="Artist 2", start_time="00:02:00", end_time="00:03:00"),
    ], [
...
def test_process_gaps(input_tracks, expected_tracks):
    timing_utils = TimingUtils()
    result = timing_utils._process_gaps(input_tracks)
