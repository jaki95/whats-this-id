...
class Track(BaseModel):
    ...
    start_time: str = Field(..., description="The start time of the track (HH:MM:SS in 24-hour format)")
    end_time: str = Field(..., description="The end time of the track (HH:MM:SS in 24-hour format)")
